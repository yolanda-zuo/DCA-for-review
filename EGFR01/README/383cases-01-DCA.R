...
countries <- c("KNN_XGB","LR_ADB","NB_LR","RF_XGB","RFFI_LGBM","Stacking_LGBM","SVM_GBDT")  #01
...
#   dev.off()
# }
png("revised-dca-internal1_01-2023.jpeg", width = 225, height = 225, units='mm', res = 1000)
# pdf("dca-external1_1921-2023.pdf")
dca(data=tabular_image_file, outcome="label", predictors=c("KNN_XGB","LR_ADB","NB_LR","RF_XGB","RFFI_LGBM","Stacking_LGBM","SVM_GBDT"), smooth="TRUE")
